...
class Beef_Project:
    ...
    def get_hooked_browsers(self, offline_mode=False, enable_print=True):
        sessions = {}
    ...
    def get_hooked_browsers_details(self, sessions):
        for k, v in sessions.items():
            ...
            if resp.status_code == 200:
                ...
                print(tabulate(total_list, headers=['Browser/System Properties', 'Details'], tablefmt='orgtbl'))
    ...
    def specific_command_module_info(self, module_id):
    ...
    def launch_command(self, session_id, module_id, method, data=None):
        if method == 'post':
            ...
            if resp.status_code == 200:
                ...
                if success == 'true':
                    self.get_info_command_module(session_id=session_id, module_id=module_id, cmd_id=cmd)
    ...
    def get_info_command_module(self, session_id, module_id, cmd_id):
        count = 10
        while count <= 10:
            ...
            if resp.status_code == 200:
                ...
                print(f"{tabulate(total_list, headers=['Date', f'Result for Module Id : {module_id} | and Command Id : {cmd_id}'], tablefmt='orgtbl')}\n\n")
                break
            count += 1
            time.sleep(10)
    ...
    def user_choice(self):
        ...
        while True:
            ...
            if int(choice) not in range(1, 13): print('[-] Invalid Selection, Select Valid Choice')
            else:
                print('\n')
                return choice
        ...
        try:
            while True:
                ...
                if cont in ['Y', 'y']: continue
                    ...
                    print('[+] Apache Server Stopped....!')
                    break
        except requests.exceptions.ConnectionError: print('[-] Connection Error, Run Beef Server')
